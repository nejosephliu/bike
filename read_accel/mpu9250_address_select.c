...
#include "mpu9250_address_select.h"

// static uint8_t MPU_ADDRESS = 0x68; // We input each address separately
static uint8_t MAG_ADDRESS = 0x0C; // Don't care about mag?????

static const nrf_twi_mngr_t* i2c_manager = NULL; // Comes from calling init
